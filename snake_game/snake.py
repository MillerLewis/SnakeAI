...
class Snake:
    ...
    def is_food_ahead(self, food):
        direction_to_food = [food.pos[0] - self.pos[0], food.pos[1] - self.pos[1]]
    ...
    def is_food_right(self, food):
        normalised_direction_to_food = [sign(food.pos[0] - self.pos[0]), sign(food.pos[1] - self.pos[1])]

        if self.heading == Snake.LEFT:
            return normalised_direction_to_food[1] == -1
        elif self.heading == Snake.RIGHT:
            return normalised_direction_to_food[1] == 1
        elif self.heading == Snake.UP:
            return normalised_direction_to_food[0] == 1
        elif self.heading == Snake.DOWN:
            return normalised_direction_to_food[0] == -1
